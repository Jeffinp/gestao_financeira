    ...
    >
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-4">
          ...
          {trend && (
            <div
              className={`flex items-center gap-1 text-sm font-medium ${trend.isPositive ? "text-shop-success" : "text-shop-error"
                }`}
            >
              {trend.isPositive ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard
                  ...
                  iconColor={
                    saldoLiquido >= 0 ? "text-shop-success" : "text-shop-error"
                  }
                  isLoading={isLoading}
                  delay={0.4}
                />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-bold text-foreground">
                          R${" "}
                          {categorias
                            .reduce((acc, cat) => acc + cat.valor, 0)
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4 p-3 bg-shop-info/10 border border-shop-info/20 rounded-lg">
                      <p className="text-sm text-shop-info">
                        Nota: Elementos decorativos de fundo foram
                        temporariamente desabilitados para melhorar a
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="relative w-32 h-32">
                            ...
                            >
                              ...
                              <motion.circle
                                ...
                                strokeDashoffset={
                                  2 * Math.PI * 50 * (1 - progressoMeta / 100)
                                }
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                              <div className="text-center">
                                <p className="text-2xl font-bold text-shop-accent">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-between items-center p-3 bg-shop-success/10 rounded-lg">
                            <span className="text-sm text-shop-success">
                              Realizado
                            </span>
                            <span className="text-sm font-bold text-shop-success">
                              R${" "}
                              {ganhosMes.toLocaleString("pt-BR", {
                                minimumFractionDigits: 2,
                              })}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between items-center p-3 bg-shop-info/10 rounded-lg">
                            <span className="text-sm text-shop-info">
                              Restante
                            </span>
                  ...
                  {isLoading ? (
                    ...
                    <div className="space-y-3">
                      {transacoesRecentes.map((transacao, index) => (
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center ${transacao.tipo === "ganho"
                          ...
                          <div className="text-right">
                            <span
                              className={`font-bold text-lg ${transacao.tipo === "ganho"
                                ? "text-shop-success"
                                : "text-shop-error"
                                }`}
                            >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card rounded-xl shadow-card border border-border/50 p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="w-full bg-muted rounded-full h-2">
                      <div
                        className="bg-shop-success h-2 rounded-full"
                        style={{ width: "72%" }}
                      ></div>
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="bg-card rounded-xl shadow-card border border-border/50 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="text-center">
                      <p className="text-lg font-bold text-shop-success">
                        R$ 1.247
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Sobra estimada
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div className="bg-card rounded-xl shadow-card border border-border/50 overflow-hidden">
                  <div className="p-6 border-b border-border/20">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Evolução dos gastos principais
                    </p>
                  </div>
                  <div className="p-6">
                    <ResponsiveContainer width="100%" height={300}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-4 bg-shop-success/5 border border-shop-success/20 rounded-xl">
                      <div className="flex items-start gap-3">
                        {" "}
                        <div className="p-2 bg-shop-success/10 rounded-lg mt-1">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mb-2">
                            Seus gastos com alimentação estão 15% acima da
                            média. Considere meal prep para economizar até R$
                            200/mês.
                          </p>
                    ...
                    <div className="p-4 bg-shop-info/5 border border-shop-info/20 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mb-2">
                            Você tende a gastar mais nos fins de semana.
                            Configure alertas para controlar gastos.
                          </p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-shop-warning">
                            57%
                          </p>
                          <p className="text-xs text-muted-foreground">
                            Concluído
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <div
                          className="bg-shop-warning h-3 rounded-full transition-all duration-500"
                          style={{ width: "57%" }}
                        ></div>
                      </div>
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-shop-success font-medium">
                          +R$ 500/mês
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-shop-accent">
                            35%
                          </p>
                          <p className="text-xs text-muted-foreground">
                            Concluído
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <div
                          className="bg-shop-accent h-3 rounded-full transition-all duration-500"
                          style={{ width: "35%" }}
                        ></div>
                      </div>
                ...
                <div className="bg-card rounded-xl shadow-card border border-border/50 overflow-hidden">
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <div
                          className="bg-shop-success h-3 rounded-full transition-all duration-500"
                          style={{ width: "62%" }}
                        ></div>
                      </div>
                ...
                <div className="bg-card rounded-xl shadow-card border border-border/50 overflow-hidden">
                  ...
                  <div className="p-6 space-y-6">
                    <div className="flex items-center justify-between p-4 bg-shop-warning/5 rounded-xl border border-shop-warning/20">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-shop-warning">
                          Nov/2025
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Conclusão prevista
                    ...
                    <div className="flex items-center justify-between p-4 bg-shop-accent/5 rounded-xl border border-shop-accent/20">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-shop-accent">
                          Jun/2025
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Conclusão prevista
                    ...
                    <div className="flex items-center justify-between p-4 bg-shop-success/5 rounded-xl border border-shop-success/20">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-shop-success">
                          Jul/2025
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Conclusão prevista
              ...
              <div className="bg-gradient-to-r from-shop-primary/10 via-shop-accent/10 to-shop-primary/10 rounded-xl p-8 border border-border/20">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                    Siga estratégias comprovadas para acelerar o progresso das
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Descubra ferramentas poderosas para otimizar sua gestão financeira
              e alcançar seus objetivos com eficiência
            </p>
