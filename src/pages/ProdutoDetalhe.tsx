...
const PRODUTO = {
  ...
  descricao:
    "Calça jeans moderna com design diferenciado, tecido de alta qualidade e confortável para uso diário. Perfeita para diversas ocasiões, desde eventos casuais até encontros mais formais.",
  avaliacao: 4.2,
  totalAvaliacoes: 124,
  imagens: [
  ...
  avaliacoes: [
    {
      ...
      data: "12/08/2023",
      nota: 5,
      comentario: "Excelente produto, qualidade surpreendente.",
    },
    {
      id: 2,
      nome: "Maria Santos",
      data: "05/07/2023",
      nota: 4,
      comentario: "Muito boa, só achei um pouco apertada no início.",
    },
    {
      id: 3,
      nome: "Pedro Oliveira",
      data: "22/06/2023",
      nota: 3,
      comentario: "Qualidade boa, mas a cor não é exatamente como na foto.",
    },
  ],
};
      ...
      <nav aria-label="Breadcrumb" className="mb-6 flex items-center text-sm">
        <ol className="flex items-center space-x-2">
          <li>
            <Link
              to="/"
              className="text-gray-500 hover:text-[hsl(var(--shop-primary))] transition-colors"
            >
              Home
            </Link>
          </li>
          ...
          <div className="grid grid-cols-4 gap-4">
            {produto.imagens.map((imagem, index) => (
              <button
                ...
                className={`overflow-hidden rounded-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--shop-primary))] ${
        ...
        >
              ...
              {produto.promocao ? (
                <div className="flex items-baseline flex-wrap gap-2">
                  ...
                  <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-[hsl(var(--shop-accent))] bg-opacity-10 text-[hsl(var(--shop-accent))]">
                    {Math.round(
                      (1 - produto.precoPromocional / produto.preco) * 100
                    )}
                    % OFF
                  </span>
                </div>
          ...
          <div>
            <h3 className="font-medium mb-2">
              Cor: <span className="text-gray-600">{corSelecionada.nome}</span>
            </h3>
            ...
            <div className="flex flex-wrap gap-2">
              {produto.tamanhos.map((tamanho) => (
                <button
                  key={tamanho.id}
                  onClick={() =>
                    tamanho.disponivel && setTamanhoSelecionado(tamanho)
                  }
                  ...
                  aria-label={`Tamanho ${tamanho.tamanho}${
                    !tamanho.disponivel ? " (indisponível)" : ""
                  }`}
                >
                  {tamanho.tamanho}
                </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              <p className="text-gray-600 text-pretty">{produto.descricao}</p>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <time
                      ...
                      dateTime={avaliacao.data.split("/").reverse().join("-")}
                    >
                      {avaliacao.data}
                    </time>
                  </div>
